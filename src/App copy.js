  ...
  return (
    <>
      ...
      <Main>
        ...
        {/* ANOTHER WAY OF RENDERING CONTENT THAN THE ONE ABOVE === PASS THE ELEMENT INSTEAD OF CHILDREN AS A PROP ==== AND IT IS CALLED SPLIING PROP  */}
...
function MovieDetails({ selectedId, onCloseMovie, onAddWatched, watched }) {
  ...
  const countRef = useRef(0); //initialising
  //updating
  useEffect(
    function () {
      if (userRating) {
  ...
  useEffect(
    function () {
      ...
      return function () {
        ...
        console.log(`clean up the effect for movie ${title}`);
      };
    },
    [title],
  );
